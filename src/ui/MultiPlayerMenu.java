...
public class MultiPlayerMenu extends javax.swing.JFrame {
    ...
    public MultiPlayerMenu() {
        ...
        this.addWindowListener(new WindowAdapter() {
            ...
            public void windowOpened(WindowEvent e) {
                ...
                MultiPlayerMenu.this.requestFocusInWindow();
            }
            ...
            .addGroup(BackgroundLayout.createSequentialGroup()
                ...
                .addGroup(BackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(BackgroundLayout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(Header, javax.swing.GroupLayout.DEFAULT_SIZE, 788, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void ButtonStartActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String player1Name = FieldName1.getText();
        String player2Name = FieldName2.getText();
        ...
        MultiPlayer multiPlayerFrame = new MultiPlayer(
            player1Name,
            player2Name,
            selectedSpeedDelay,
            player1Colour,
    ...
    private void FieldName2FocusLost(java.awt.event.FocusEvent evt) {
        if (FieldName1.getText().trim().isEmpty()) { 
            FieldName1.setText("Enter player 2 name.");
        }
    }
    ...
    private String getPlayer2SelectedColor() {
    return "Blue"; 
    }
    
    private int getSelectedSpeedDelay() {
    return 100; 
}
    
    private boolean getBorderOption() {
    return true; 
}
...
private void updatePreviewImages() {
    ...
    // memanggil method update preview
